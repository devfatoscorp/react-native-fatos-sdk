...
export default class FatosNavigationView extends Component {
    ...
    getPathLineColorDiglog()
    {
        ...
        var dialog = <Dialog
            ...
            dialogTitle={
                <DialogTitle title={strRouteColor} align="left" />
            }
    ...
    getPathLineColorDiglogContent()
    {
        ...
        var dialogContent = <View style={ styles.optionView2 }>
            <View style={ styles.optionCol }>
                <TouchableOpacity style={pathLineColor == 0 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressPathLineColor(0) }}>
                    <FastImage style={styles.routeImageStyle} source={routeImg[0]} />
                </TouchableOpacity>
                <TouchableOpacity style={pathLineColor == 1 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressPathLineColor(1) }}>
                    <FastImage style={styles.routeImageStyle} source={routeImg[1]} />
                </TouchableOpacity>
                <TouchableOpacity style={pathLineColor == 2 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressPathLineColor(2) }}>
                    <FastImage style={styles.routeImageStyle} source={routeImg[2]} />
                </TouchableOpacity>
                <TouchableOpacity style={pathLineColor == 3 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressPathLineColor(3) }}>
    ...
    getRouteOptionDialog()
    {
        ...
        var dialog = <Dialog
            ...
            dialogTitle={
                <DialogTitle title={strRouteOption} align="left" />
            }
            dialogAnimation={new SlideAnimation({ slideFrom: 'bottom' })}
        >
    ...
    getRouteOptionDialogContent()
    {
        ...
        var dialogContent = <View style={ styles.optionView1 }>
            <View style={ styles.optionCol }>
                <TouchableOpacity style={this.state.routeOption[0] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressRouteOption(0) }}>
                    <Text style={ styles.optionText }>{strRecommended}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={this.state.routeOption[1] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressRouteOption(1) }}>
                    <Text style={ styles.optionText }>{strExpresswayPriority}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={this.state.routeOption[2] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressRouteOption(2) }}>
                    <Text style={ styles.optionText }>{strFreeroodfirst}</Text>
                </TouchableOpacity>
            </View>
            <View style={ styles.optionCol }>
                <TouchableOpacity style={this.state.routeOption[3] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressRouteOption(3) }}>
                    <Text style={ styles.optionText }>{strAvoidTollroads}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={this.state.routeOption[4] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressRouteOption(4) }}>
    ...
    getMapColorDiglog()
    {
        ...
        var dialog = <Dialog
            ...
            dialogTitle={
                <DialogTitle title={strMapthemes} align="left" />
            }
            dialogAnimation={new SlideAnimation({ slideFrom: 'bottom' })}
        >
    ...
    getCameraOptionDialog()
    {
        ...
        var dialog = <Dialog
            ...
            dialogTitle={
                <DialogTitle title={strSpeedAlert} align="left" />
            }
            dialogAnimation={new SlideAnimation({ slideFrom: 'bottom' })}
        >
    ...
    getCameraOptionDialogContent()
    {
        ...
        var dialogContent = <View style={ styles.optionView1 }>
            <View style={ styles.optionCol }>
                <TouchableOpacity style={this.state.cameraOption[0] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCameraOption(0) }}>
                    <Text style={ styles.optionText }>{strFixedCam}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={this.state.cameraOption[1] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCameraOption(1) }}>
                    <Text style={ styles.optionText }>{strMobileCam}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={this.state.cameraOption[2] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCameraOption(2) }}>
                    <Text style={ styles.optionText }>{strSignalControl}</Text>
                </TouchableOpacity>
            </View>
            <View style={ styles.optionCol }>
                <TouchableOpacity style={this.state.cameraOption[3] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCameraOption(3) }}>
                    <Text style={ styles.optionText }>{strIntervention}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={this.state.cameraOption[4] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCameraOption(4) }}>
                    <Text style={ styles.optionText }>{strPaking}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={this.state.cameraOption[5] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCameraOption(5) }}>
    ...
    getOperationStateDiglog()
    {
        ...
        var dialog = <Dialog
            ...
            dialogTitle={
                <DialogTitle title={strDriveCatefully} align="left" />
            }
            dialogAnimation={new SlideAnimation({ slideFrom: 'bottom' })}
        >
    ...
    getOperationStateDiglogContent()
    {
        ...
        var dialogContent = <View style={ styles.optionView2 }>
            <View style={ styles.optionCol }>
                <TouchableOpacity style={this.state.operationState[0] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressOperationState(0) }}>
                    <Text style={ styles.optionText }>{strSharpCurve}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={this.state.operationState[1] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressOperationState(1) }}>
                    <Text style={ styles.optionText }>{strChild}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={this.state.operationState[2] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressOperationState(2) }}>
    ...
    getFacilityDiglog()
    {
        ...
        var dialog = <Dialog
            ...
            dialogTitle={
                <DialogTitle title={strFacilty} align="left" />
            }
            dialogAnimation={new SlideAnimation({ slideFrom: 'bottom' })}
        >
    ...
    getFacilityDiglogContent()
    {
        ...
        var dialogContent = <View style={ styles.optionView2 }>
            <View style={ styles.optionCol }>
                <TouchableOpacity style={this.state.facility[0] == true ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressFacility(0) }}>
    ...
    getRediscoverDiglog()
    {
        ...
        var dialog = <Dialog
            ...
            dialogTitle={
                <DialogTitle title={strAutoReRoute} align="left" />
            }
            dialogAnimation={new SlideAnimation({ slideFrom: 'bottom' })}
        >
    ...
    getWayPointDiglog()
    {
        ...
        var dialog = <Dialog
            ...
            dialogTitle={
                <DialogTitle title={strWatpoint} align="left" />
            }
            dialogAnimation={new SlideAnimation({ slideFrom: 'bottom' })}
        >
    ...
    getCarTypeDialog()
    {
        ...
        var dialog = <Dialog
            ...
            dialogTitle={
                <DialogTitle title={strVehicleType} align="left" />
            }
            dialogAnimation={new SlideAnimation({ slideFrom: 'bottom' })}
        >
    ...
    getCarTypeDialogContent()
    {
        ...
        var dialogContent = <View style={ styles.optionView1 }>
            <View style={ styles.optionCol }>
                <TouchableOpacity style={carType == 0 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCarType(0) }}>
                    <Text style={ styles.optionText }>{strCompact}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={carType == 1 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCarType(1) }}>
                    <Text style={ styles.optionText }>{strPassenger}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={carType == 2 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCarType(2) }}>
                    <Text style={ styles.optionText }>{strSuv}</Text>
                </TouchableOpacity>
            </View>
            <View style={ styles.optionCol }>
                <TouchableOpacity style={carType == 3 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCarType(3) }}>
                    <Text style={ styles.optionText }>{strMpv}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={carType == 4 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCarType(4) }}>
                    <Text style={ styles.optionText }>{strTruck}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={carType == 5 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCarType(5) }}>
    ...
    getFuelDialog()
    {
        ...
        var dialog = <Dialog
            ...
            dialogTitle={
                <DialogTitle title={strFuel} align="left" />
            }
            dialogAnimation={new SlideAnimation({ slideFrom: 'bottom' })}
        >
    ...
    getFuelDialogContent()
    {
        ...
        var dialogContent = <View style={ styles.optionView2 }>
            <View style={ styles.optionCol }>
                <TouchableOpacity style={fuel == 0 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressFuel(0) }}>
                    <Text style={ styles.optionText }>{strGasoline}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={fuel == 1 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressFuel(1) }}>
                    <Text style={ styles.optionText }>{strDiesel}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={fuel == 2 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressFuel(2) }}>
                    <Text style={ styles.optionText }>{'LPG'}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={fuel == 3 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressFuel(3) }}>
    ...
    getSeatPositionDiglog()
    {
        ...
        var dialog = <Dialog
            ...
            dialogTitle={
                <DialogTitle title={strDriverPos} align="left" />
            }
            dialogAnimation={new SlideAnimation({ slideFrom: 'bottom' })}
        >
    ...
    getCarvataDiglog()
    {
        ...
        var dialog = <Dialog
            ...
            dialogTitle={
                <DialogTitle title={strCarIconStyle} align="left" />
            }
            dialogAnimation={new SlideAnimation({ slideFrom: 'bottom' })}
        >
    ...
    getCarvataDiglogContent()
    {
        ...
        var dialogContent = <View style={ styles.optionView2 }>
            <View style={ styles.optionCol }>
                <TouchableOpacity style={carvata == 0 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCarvata(0) }}>
                    <FastImage style={styles.routeImageStyle} source={carvataImg[0]} />
                </TouchableOpacity>
                <TouchableOpacity style={carvata == 1 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCarvata(1) }}>
                    <FastImage style={styles.routeImageStyle} source={carvataImg[1]} />
                </TouchableOpacity>
                <TouchableOpacity style={carvata == 2 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCarvata(2) }}>
                    <FastImage style={styles.routeImageStyle} source={carvataImg[2]} />
                </TouchableOpacity>
                <TouchableOpacity style={carvata == 3 ? styles.optionItem1 : styles.optionItem2}
                                  activeOpacity={0.7} onPress={() => { this.onPressCarvata(3) }}>
    ...
    render() {
        ...
        return  <View style={styles.navigationView} >
            <ScrollView>
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.2} onPress={() => { this.showPathLineColor() }} >
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.showCarvataDialog() }}>
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.showRouteOption() }}>
                    <View style={styles.tabViewItemLeft2}>
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.showMapColor() }}>
                    <View style={styles.tabViewItemLeft}>
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.setDem() }}>
                    <View style={styles.tabViewItemLeft}>
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.setSmartMode() }}>
                    <View style={styles.tabViewItemLeft}>
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.showCameraOption() }}>
                    <View style={styles.tabViewItemLeft}>
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.showOperationStateDialog() }}>
                    <View style={styles.tabViewItemLeft}>
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.showFacilityDialog() }}>
                    <View style={styles.tabViewItemLeft}>
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.showGuidevoiceDialog() }}>
                    <View style={styles.tabViewItemLeft}>
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.showRediscoverDialog() }}>
                    <View style={styles.tabViewItemLeft2}>
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.showWayPointDialog() }}>
                    <View style={styles.tabViewItemLeft}>
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.setHiPass() }}>
                    <View style={styles.tabViewItemLeft}>
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.showCarTypeDialog() }}>
                    <View style={styles.tabViewItemLeft}>
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.showFuelDialog() }}>
                    <View style={styles.tabViewItemLeft}>
                ...
                <TouchableOpacity style={styles.tabViewItem} activeOpacity={0.7} onPress={() => { this.showSeatPositionDialog() }}>
                    <View style={styles.tabViewItemLeft}>
