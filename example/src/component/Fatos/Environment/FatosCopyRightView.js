...
export default class FatosCopyRightView extends Component {
    ...
    getWebView()
    {
        ...
        {
            webview = <WebView originWhitelist={["file://"]} source={{uri: isAndroid ? 'file:///android_asset/html/copyright_fatos.html'
        ...
        {
            webview =  <WebView originWhitelist={["file://"]} source={{uri: isAndroid ? 'file:///android_asset/html/copyright_fatos_eng.html'
