...
export default class FatosTermsView extends Component {
    ...
    getWebView()
    {
        ...
        if(FatosLanguageManager.GetInstance().getLanguageIndex() == COMMON.LANGUAGE_TYPE.eLANGUAGE_TYPE_SMALL)
        {
            webview = <WebView originWhitelist={["file://"]} source={{uri: isAndroid ? 'file:///android_asset/html/termsofuse_fatos.html'
                    : './assets/html/termsofuse_fatos.html'}}/>;
        }
        else if(FatosLanguageManager.GetInstance().getLanguageIndex() == COMMON.LANGUAGE_TYPE.eLANGUAGE_TYPE_ENGLISH)
        {
            webview = <WebView originWhitelist={["file://"]} source={{uri: isAndroid ? 'file:///android_asset/html/termsofuse_fatos_eng.html'
