...
import {
    ...
    View,
    StyleSheet,
    TouchableOpacity, NativeModules, NativeEventEmitter,
} from 'react-native'
...
const menuImg = [
    require('../../../res/drawable/btn_1_6_2_hi.png')
];

const rescanImg = [
    require('../../../res/drawable/m_m_button_icon_11_nor.png')
];

const triangleImg = [
    require('../../../res/drawable/info_cion_triangle.png')
];
...
export default class FatosBottomView extends Component {
    ...
    constructor(props) {
        ...
        this.mapViewEmitter.addListener(
            'PosWorldLocationUpdateListener',
            (data) => this.setState({ posWorldLocation : data })
        );
    ...
    getFleetDriverMenuView()
    {
        ...
        if(this.rgData.DriveMode === COMMON.eDriveMode.eDrive_RG || this.rgData.DriveMode === COMMON.eDriveMode.eDrive_Simulation)
        {
            menuView = <View style={ styles.menuView }>

                <TouchableOpacity activeOpacity={ 0.7 } onPress={() => { this.onGoTask() }}>
                ...
                <TouchableOpacity activeOpacity={ 0.7 } onPress={() => { this.onSimulatedDriving() } }>
                    <View style={ styles.menuItem }>
                        <Text style={ styles.menuText }>
                            {'모의주행'}
                        </Text>
        ...
        else
        {
            ...
            {
                simulatedButton = <TouchableOpacity activeOpacity={ 0.7 } onPress={() => { this.onSimulatedDriving() } }>
                    <View style={ styles.menuItem }>
                        <Text style={ styles.menuText }>
                            {'모의주행'}
                        </Text>
            ...
            menuView = <View style={ styles.menuView }>
                ...
                <TouchableOpacity activeOpacity={ 0.7 } onPress={() => { this.onPressRouteTest1() }}>
                    <View style={ styles.menuItem } >
                        <Text style={ styles.menuText }>
                            {'집으로'}
                        </Text>
                ...
                <TouchableOpacity activeOpacity={ 0.7 } onPress={() => { this.onPressRouteTest2() }}>
                    <View style={ styles.menuItem } >
                        <Text style={ styles.menuText }>
                            {'회사로'}
                        </Text>
                ...
                <TouchableOpacity activeOpacity={ 0.7 } onPress={() => { this.onPressCancelRoute() }}>
                    <View style={ styles.menuItem } >
                        <Text style={ styles.menuText }>
                            {'경로안내 취소'}
                        </Text>
                ...
                <TouchableOpacity activeOpacity={ 0.7 } onPress={() => { this.onPressCancelDriving() }}>
                    <View style={ styles.menuItem }>
                        <Text style={ styles.menuText }>
                            {`CANCEL\nDRIVING`}
                        </Text>
    ...
    gethiMenuView()
    {
        ...
        if(this.rgData.DriveMode === COMMON.eDriveMode.eDrive_RG || this.rgData.DriveMode === COMMON.eDriveMode.eDrive_Simulation)
        {
            menuView = <View style={ styles.menuView }>
                ...
                <TouchableOpacity activeOpacity={ 0.7 } onPress={() => { this.onPressRouteSummary() }}>
                    <View style={ styles.menuItem } >
                        <Text style={ styles.menuText }>
                            {strRouteInfo}
                        </Text>
                ...
                <TouchableOpacity activeOpacity={ 0.7 } onPress={() => { this.onPressEnvironment() }}>
                    <View style={ styles.menuItem } >
                        <Text style={ styles.menuText }>
                            {strSettings}
                        </Text>
    ...
    render () {
        ...
        if(this.state.driveSimulatedViewShow === true)
        {
            ...
            {
                driveSimulatedView = <View style={ styles.driveSimulatedView }>

                    <TouchableOpacity style={ styles.driveSimulatedItem } activeOpacity={ 0.7 } onPress={() => { this.onDriveControl() }}>
                        <FastImage style={ styles.driveSimulatedItem }
                                   source={ driveControlImg[this.state.driveControl] } />
                    </TouchableOpacity>

                    <TouchableOpacity style={ styles.driveSimulatedItem } activeOpacity={ 0.7 } onPress={() => { this.onDriveSpeed() }}>
                        <FastImage style={ styles.driveSimulatedItem }
                                   source={ driveSpeedImg[this.state.driveSpeed] } />
                    </TouchableOpacity>

                    <TouchableOpacity style={ styles.driveSimulatedItem } activeOpacity={ 0.7 } onPress={() => { this.onDriveClose() }}>
                        <FastImage style={ styles.driveSimulatedItem }
        ...
        if(this.rgData != null)
        {
            ...
            if(this.rgData.DriveMode === COMMON.eDriveMode.eDrive_RG || this.rgData.DriveMode === COMMON.eDriveMode.eDrive_Simulation) {
                ...
                drivingInfoView = <View style={ styles.drivingInfoView }>
                    <TouchableOpacity style={ styles.drivingTimeInfoView } activeOpacity={ 0.7 } onPress={() => { this.onDrivingTime() }}>
                        <Text style={ styles.drivingTimeInfoText1 }>
                            {strCurTime}
                        </Text>

                        <Text style={ styles.drivingTimeInfoText2 }>
                            {strAmFm}
                        </Text>

                        <FastImage style={styles.ImageStyle2}
                                   source={ triangleImg[0] } />
                    </TouchableOpacity>
                    ...
                    <View style={ styles.drivingKmInfoView }>
                        <Text style={ styles.drivingTimeInfoText3 }>
                            {strDistance}
                        </Text>
                    </View >
                </View >
        ...
        bottomView = <View style={ styles.bottomView }>
            ...
            <TouchableOpacity activeOpacity={ 0.7 } onPress={() => { this.onPressMenu() }}>
