...
const currpos = [
    require('../../../res/drawable/curpos_2_5_1.png')
];
...
const zoomLevel = [
    require('../../../res/drawable/d_zoom_level_bg.png')
];
...
export default class FatosRGView extends Component {
    ...
    constructor(props) {
        super(props);
        this._onPressViewMode = this._onPressViewMode.bind(this);
        this._onPressAirlineMode = this._onPressAirlineMode.bind(this);
        this._onPressMapLevelIn = this._onPressMapLevelIn.bind(this);
        this._onPressMapLevelOut = this._onPressMapLevelOut.bind(this);
        this._onPressMapAuto = this._onPressMapAuto.bind(this);
        ...
        this.nativesEmitter.addListener(
            'MapLevelUpdateListener',
            (data) => this.setState({ maplevel : data })
        );
    ...
    _onPressMapLevelIn = () =>{
        this.native.MapLevelIn();
    };

    _onPressMapLevelOut = () =>{
        this.native.MapLevelOut();
    };
    ...
    render () {
        ...
        {
            mapAutoButton = <TouchableOpacity activeOpacity={0.7} onPress={() => { this._onPressMapAuto() }}>
        ...
        return <View style={styles.container}>
            <View style={styles.zoomContainer}>
                ...
                {/* Compass Button */}
                <TouchableOpacity activeOpacity={0.7} onPress={() => { this._onPressViewMode() }}>
                    <FastImage source={viewmode_bg}
                ...
                {/* Aero Button */}
                <TouchableOpacity activeOpacity={0.7} onPress={() => { this._onPressAirlineMode() }}>
                    <FastImage source={compass_bg[0]} style={styles.TextBackgroundStyle2} >
                        <FastImage style={styles.ImageStyle}
                               source={aero_img} />
                    </FastImage>
                ...
                {/* Map Level Button */}
                <TouchableOpacity activeOpacity={0.7} onPress={() => { this._onPressMapLevelIn() }}>
                    <FastImage style={styles.ImageStyle}
                           source={zoomUp[0]} />
                </TouchableOpacity>
                ...
                <TouchableOpacity activeOpacity={0.7} onPress={() => { this._onPressMapLevelOut() }}>
                    <FastImage style={styles.ImageStyle}
                           source={zoomDown[0]} />
                </TouchableOpacity>
