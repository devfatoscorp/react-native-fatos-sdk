...
- (instancetype)init
{
  ...
  if (self = [super init]) {
    ...
    [AppDelegate sharedAppDelegate].webViewManager = self;
...
- (UIView *)view
{
  ...
  // 웹뷰 바인딩 될동안 로딩 처리
  FatosNaviBridgeModule *module = [AppDelegate sharedAppDelegate].fatosNaviBridgeModule;
...
{
  FatosNaviModule *fatosNaviModule = [AppDelegate sharedAppDelegate].fatosNaviModule;
